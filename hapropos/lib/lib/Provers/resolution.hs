...
import Prop
import Typeclasses.Resolution (Resolution, ResolutionInput(..), ResolutionOutput(..), resolution)
...
proveTheorem :: (Resolution prop, Ord prop) => ResolutionInput prop -> ResolutionOutput prop
